...
//OBJETIVO 1
    ...
    botoes.forEach(botao => {
        ...
        // passo 3 - verificar se já existe um botão selecionado, se sim, devemos remover 
        // a seleção dele
            const botaoSelecionado  = document.querySelector('.botao.selecionado')//ponto necessario por se tratar de um seletor
...
//OBJETIVO 2 ////////
    ...
    botoes.forEach((botao, indice) => {
        ...
        // passo 3 - verificar se já exista um personagem selecionado, se sim, devemos remover 
         // a seleção dele
            desselecionarPersonagem()//REFAtORaMENTO GLOBAL
...
function desselecionarPersonagem() {//FUNCAO DO REFAtorAMENTO GLOB
